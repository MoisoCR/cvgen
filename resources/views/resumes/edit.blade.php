...
<div class="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-lg">
    ...
    <form action="{{ route('resumes.update', $resume->id) }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <textarea id="languages" name="languages" required class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('skills', $resume->skills) }}</textarea>
        </div>
